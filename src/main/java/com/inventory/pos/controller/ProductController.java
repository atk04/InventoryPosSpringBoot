...
public class ProductController {
    ...
    //if exit image, @RequestParam("productImage") MultipartFile productImage is required
...
//        }
        ...
        //for only product save without image
        Product product = productService.createProduct(createProductRequest);
        message = product.getName();
        //
    ...
    public ResponseEntity updateProduct(@RequestPart UpdateProductRequest updateProductRequest) {
